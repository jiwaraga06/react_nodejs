...
const Login = () => {
    ...
    const postLogin = async () => {
        ...
        console.log(data);
        try {
            const response = await fetch('http://192.168.50.8:8000/auth/api/v1/login', {
                method: 'POST',
                headers: {
                    ...
                    <Card sx={{ width: 400 }}>
                        <CardContent>
                            ...
                            <div className="d-flex justify-content-center m-2 mt-4">
                                <Button type="submit" variant="contained" fullWidth={true} style={{ backgroundColor: "#393E46" }} onClick={postLogin}>Login</Button>
                            </div>
                        </CardContent>
                    </Card>
                </div>
